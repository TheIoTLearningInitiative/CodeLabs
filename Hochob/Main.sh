...
export HOCHOB_MEDIA_CAMERA_FSWEBCAM=$HOCHOB_MEDIA_IMAGE_VISITORS/Fswebcam/
export HOCHOB_MEDIA_CAMERA_FSWEBCAM_IMAGE=$HOCHOB_MEDIA_IMAGE_VISITORS_FSWEBCAM/hbsCameraFswImage.jpg

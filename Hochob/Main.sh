...
export HOCHOB_SERVER_SERVICES_AMIKOO_REMOTE=$HOCHOB_SERVER_SERVICES_AMIKOO/Amikoo/Remote/
export HOCHOB_SERVER_SERVICES_AMIKOO_VIRTUAL=$HOCHOB_SERVER_SERVICES_AMIKOO/Amikoo/Virtual/
...
export TRADITION=$HOCHOB_SERVER_MEDIA_TRADITION

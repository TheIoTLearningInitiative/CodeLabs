...
export HOCHOB_MEDIA_SOUND_ESPEAK=$HOCHOB_MEDIA_SOUND/Espeak/
export HOCHOB_MEDIA_SOUND_ESPEAK_OUTPUT=$HOCHOB_MEDIA_SOUND_ESPEAK/hbsSoundSsEspeakOutput.wav

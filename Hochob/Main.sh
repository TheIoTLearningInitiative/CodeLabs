...
export HOCHOB_SERVICES_SOUND_PX=$HOCHOB_SERVICES_SOUND/Play/
...
export HOCHOB_MEDIA_SOURCE_CAMERA_FSWEBCAM=$HOCHOB_MEDIA_IMAGE_VISITORS/Fswebcam/
export HOCHOB_MEDIA_SOURCE_CAMERA_FSWEBCAM_IMAGE=$HOCHOB_MEDIA_IMAGE_VISITORS_FSWEBCAM/hbsCameraFswImage.jpg
...
export HOCHOB_MEDIA_SOUND_STREAM_ESPEAK_OUTPUT=$HOCHOB_MEDIA_SOUND_STREAM_ESPEAK/hbsSoundSsEspeakOutput.wav

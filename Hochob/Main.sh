...
export HOCHOB_SERVER_MEDIA_VISITORSCENTER_MEMORIES=$HOCHOB_SERVER_MEDIA_VISITORSCENTER/Memories/
...
export HOCHOB_SERVER_MEDIA_VISITORSCENTER_APLICATIONS=$HOCHOB_SERVER_MEDIA_VISITORSCENTER/Applications/
export HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA=$HOCHOB_SERVER_MEDIA_VISITORSCENTER_APLICATIONS/Area/
export HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA_SOUTERN_MAYA_HIGHLANDS=$HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA/SouthernMayaHighlands
export HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA_CENTRAL_MAYA_LOWLANDS=$HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA/CentralMayaLowlands
export HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA_NORTHERN_MAYA_LOWLANDS=$HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA/NorthernMayaLowlands
...
export AREA_SOUTERN_MAYA_HIGHLANDS=$HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA_SOUTERN_MAYA_HIGHLANDS
export AREA_CENTRAL_MAYA_LOWLANDS=$HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA_CENTRAL_MAYA_LOWLANDS
export AREA_NORTHERN_MAYA_LOWLANDS=$HOCHOB_SERVER_MEDIA_VISITORSCENTER_APPLICATIONS_AREA_NORTHERN_MAYA_LOWLANDS

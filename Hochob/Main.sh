...
export HOCHOB_SERVER_CONFIGURATION_ROBOTAVAILABLE=$HOCHOB_SERVER_CONFIGURATION/robotavailable
...
export HOCHOB_SERVER_SERVICES_ROBOT_VIRTUAL=$HOCHOB_SERVER_SERVICES_ROBOT/Virtual/
...
export PATH=$PATH:$HOCHOB_SERVER_SERVICES_ROBOT_VIRTUAL

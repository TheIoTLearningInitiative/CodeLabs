...
export HOCHOB_SERVER_MEDIA_TRADITION_HALLOWEEN=$HOCHOB_SERVER_MEDIA_TRADITION/Halloween
export HOCHOB_SERVER_MEDIA_TRADITION_CHRISTMAS=$HOCHOB_SERVER_MEDIA_TRADITION/Christmas
...
export TRADITION_INTEL_GUADALAJARA=$HOCHOB_SERVER_MEDIA_TRADITION_INTELGUADALAJARA
export TRADITION_VISITORS_CENTER=$HOCHOB_SERVER_MEDIA_TRADITION_VISITORS_CENTER
export TRADITION_HALLOWEEN=$HOCHOB_SERVER_MEDIA_TRADITION_HALLOWEEN
export TRADITION_CHRISTMAS=$HOCHOB_SERVER_MEDIA_TRADITION_CHRISTMAS

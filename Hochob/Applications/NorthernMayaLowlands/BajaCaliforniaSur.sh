...
Vlc.sh "off" "$APPLICATIONS_VIDEO/Silencio.mp4" &
(Robot.sh lupe/inicial 1) && sleep 1.25

Vlc.sh "off" "$APPLICATIONS_VIDEO/Parte1_v3.mp4" &
sleep 6.35 && Robot.sh lupe/emocion 1 && sleep 4

Vlc.sh "off" "$APPLICATIONS_VIDEO/Parte2_v2.mp4" &
sleep 2.7 && Robot.sh lupe/porsupuesto 1 && sleep 2.5

Vlc.sh "off" "$APPLICATIONS_VIDEO/Parte3_v2.mp4" &
...
Vlc.sh "off" "$APPLICATIONS_VIDEO/Parte4_v2.mp4" &
...
Vlc.sh "off" "$APPLICATIONS_VIDEO/Parte5_v2.mp4" &
sleep 75

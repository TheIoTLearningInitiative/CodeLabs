...
export HBS_SOUND_SS_ESPEAK_ROOT=$HOCHOB_SERVER_SERVICES_SOUND_SS
...
export HBS_SOUND_SS_ESPEAK_DIRECTORY=$HOCHOB_SERVER_MEDIA_SOUND_STREAM_ESPEAK
export HBS_SOUND_SS_ESPEAK_OUTPUT=$HOCHOB_SERVER_MEDIA_SOUND_STREAM_ESPEAK_OUTPUT

...
def functionSensorLuxes():
    ...
    while True:
        ...
        topic = "cochinitapibil/lomo/sensor/luxes"
...
def functionBinarySensorMotion():
    ...
    while True:
        ...
        topic = "cochinitapibil/lomo/binarysensor/motion"
        mqttclient.publish(topic, data)
        time.sleep(1)
...
def functionBinarySensorOpening():
    ...
    while True:
        ...
        topic = "cochinitapibil/lomo/binarysensor/opening"
        mqttclient.publish(topic, data)
        time.sleep(1)
...
def functionSwitch():
    ...
    mqttclient.connect(mqttserver, mqttport, 60)
    mqttclient.subscribe("cochinitapibil/lomo/switch", 0)

...
def functionSensorLuxes():
    ...
    while True:
        ...
        topic = "cochinitapibil/naranja/sensor/luxes"
...
def functionBinarySensorMotion():
    ...
    while True:
        ...
        topic = "cochinitapibil/naranja/binarysensor/motion"
        mqttclient.publish(topic, data)
        time.sleep(1)
...
def functionBinarySensorOpening():
    ...
    while True:
        ...
        topic = "cochinitapibil/naranja/binarysensor/opening"
        mqttclient.publish(topic, data)
        time.sleep(1)
...
def functionSwitch():
    ...
    mqttclient.connect(mqttserver, mqttport, 60)
    mqttclient.subscribe("cochinitapibil/naranja/switch", 0)

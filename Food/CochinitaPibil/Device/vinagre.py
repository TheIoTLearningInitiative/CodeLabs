...
def functionSensorLuxes():
    ...
    while True:
        ...
        topic = "cochinitapibil/vinagre/sensor/luxes"
...
def functionBinarySensorMotion():
    ...
    while True:
        ...
        topic = "cochinitapibil/vinagre/binarysensor/motion"
        mqttclient.publish(topic, data)
        time.sleep(1)
...
def functionBinarySensorOpening():
    ...
    while True:
        ...
        topic = "cochinitapibil/vinagre/binarysensor/opening"
        mqttclient.publish(topic, data)
        time.sleep(1)
...
def functionSwitch():
    ...
    mqttclient.connect(mqttserver, mqttport, 60)
    mqttclient.subscribe("cochinitapibil/vinagre/switch", 0)

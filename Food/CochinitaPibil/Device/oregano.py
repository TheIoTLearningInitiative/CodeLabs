...
def functionSensorLuxes():
    ...
    while True:
        ...
        topic = "cochinitapibil/oregano/sensor/luxes"
...
def functionBinarySensorMotion():
    ...
    while True:
        ...
        topic = "cochinitapibil/oregano/binarysensor/motion"
        mqttclient.publish(topic, data)
        time.sleep(1)
...
def functionBinarySensorOpening():
    ...
    while True:
        ...
        topic = "cochinitapibil/oregano/binarysensor/opening"
        mqttclient.publish(topic, data)
        time.sleep(1)
...
def functionSwitch():
    ...
    mqttclient.connect(mqttserver, mqttport, 60)
    mqttclient.subscribe("cochinitapibil/oregano/switch", 0)
